...
* toschain.conf: contains configuration settings for toschaind or toschain-qt
* toschaind.pid: stores the process id of toschaind while running
...
* debug.log: contains debug information and general logging generated by toschaind or toschain-qt
