...
Hash256& Hash256::Write(const unsigned char* data, size_t len)
{
    secp256k1_sha256_write(&ctx, data, len);
    return *this;
}
...
/* 	secp256k1_sha256_t ctx;
	...
	secp256k1_sha256_finalize(&ctx, hash.data()); */
	Hash256 hash256;
	hash256.Write(_input.data(),_input.size());
	h256 hash;
	hash256.Finalize(hash.data());
	return hash;
}
