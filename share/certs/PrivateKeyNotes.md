...
unlocked to sign the TOS-Qt.app bundle.
...
allowing somebody to distribute a TOS-Qt.app or tos-qt-setup.exe with a valid
...
that the tos-qt.exe file inside the installer had not been tampered with.
