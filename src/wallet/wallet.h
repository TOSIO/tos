...
#ifndef TOSCHAIN_WALLET_WALLET_H
#define TOSCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this toschain node, and set to 0 for transactions that were created
...
#endif // TOSCHAIN_WALLET_WALLET_H
