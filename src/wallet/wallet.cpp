...
{
    return strprintf("CInput(%s, %d, %d) [%s]", tx->GetHash().ToString(), i, nDepth, FormatMoney(tx->tx->vin[i].nValue));
}
...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/toschain/toschain/pull/10340, but that change has been
    // postponed until after https://github.com/toschain/toschain/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-toschain-address
 ...
 * https://toschaintalk.org/?topic=54527, or
 * https://github.com/toschain/toschain/pull/1393.
 */
