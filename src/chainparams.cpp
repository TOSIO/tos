...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // tos
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp(""))));// tos
    return genesis;
}
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 2400 * COIN);
        ...
        vSeeds.emplace_back("seed.toschain.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.toschain.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.toschainstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.toschain.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.tos.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, 1, 2400 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.emplace_back("testnet-seed.toschain.jonasschnelli.ch");
        vSeeds.emplace_back("seed.ttos.petertodd.org");
        vSeeds.emplace_back("seed.testnet.toschain.sprovoost.nl");
