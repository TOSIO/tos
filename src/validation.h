...
#ifndef TOS_VALIDATION_H
#define TOS_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 30 * 24 * 60 * 60; //tos value is 24 hours. Ours is 30 days in case something causes the chain to get stuck in testnet
