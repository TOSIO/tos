...
tvmc_status_code transactionExceptionToTvmcStatusCode(TransactionException ex) noexcept
{
    switch (ex)
    {
    ...
    case TransactionException::OutOfGas:
        return TVMC_OUT_OF_GAS;

    case TransactionException::BadInstruction:
        return TVMC_UNDEFINED_INSTRUCTION;

    case TransactionException::OutOfStack:
        return TVMC_STACK_OVERFLOW;

    case TransactionException::StackUnderflow:
        return TVMC_STACK_UNDERFLOW;

    case TransactionException ::BadJumpDestination:
        return TVMC_BAD_JUMP_DESTINATION;
...
CallResult ExtVM::call(CallParameters& _p)
{
    ...
    return {transactionExceptionToTvmcStatusCode(e.getException()), e.takeOutput()};
}
...
CreateResult ExtVM::create(u256 _endowment, u256& io_gas, bytesConstRef _code, Instruction _op, u256 _salt, OnOpFunc const& _onOp)
{
	...
	io_gas = e.gas();
	return {transactionExceptionToTvmcStatusCode(e.getException()), e.takeOutput(), e.newAddress()};
}
